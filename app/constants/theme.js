...
export const FONTS = {
    fontLg   : {fontSize:SIZES.fontLg,color: COLORS.text, lineHeight:20, fontFamily:'OpenSans-Regular'},
    font   : {fontSize:SIZES.font,color: COLORS.text, lineHeight:20, fontFamily:'OpenSans-Regular'},
	fontSm : {fontSize:SIZES.fontSm,color: COLORS.text, lineHeight:18, fontFamily:'OpenSans-Regular'},
	fontXs : {fontSize:SIZES.fontXs,color: COLORS.text, lineHeight:14, fontFamily:'OpenSans-Regular'},
