    ...
    return (
        <SafeAreaView style={{flex:1,backgroundColor:COLORS.backgroundColor}}>
            ...
            <ScrollView contentContainerStyle={{paddingBottom:20}}>
                ...
                <View style={{...GlobalStyleSheet.container,flexDirection:'row',alignItems:'center'}}>
                    <Text style={{...FONTS.h4,flex:1,color:COLORS.secondary}}>On Trending</Text>
                    <TouchableOpacity>
                        <Text style={{...FONTS.font,...FONTS.fontBold,color:COLORS.primary}}>View more</Text>
                    </TouchableOpacity>
                </View>
                
                <View
                    style={{flexDirection:'row',flexWrap:'wrap',paddingHorizontal:8,marginBottom:15}}
                >
